...
interface IOptions {
    event CreateOption(uint256 indexed optionId, address indexed holder, uint256 period, uint256 optionSize, uint256 strike, OptionType optionType, uint256 indexed poolId, IOracle oracle, uint256 protocolFee, uint256 poolFee, uint256 totalPremium);
